...
#include "BoxType2.generated.h"

class AThePackage;

UCLASS()
class THANKYOUFORSERVICE_API ABoxType2 : public AActor
{
	GENERATED_BODY()
...
private:
	...
	UStaticMesh* boxType2;
	UStaticMesh* boxType2Highlight;
	UStaticMesh* boxType2Lid;
