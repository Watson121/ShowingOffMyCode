...
#include "BoxType3.generated.h"

class AThePackage;

UCLASS()
class THANKYOUFORSERVICE_API ABoxType3 : public AActor
{
	GENERATED_BODY()
...
private:
	...
	UStaticMesh* boxType3;
	UStaticMesh* boxType3Highlight;
	UStaticMesh* boxType3Lid;
